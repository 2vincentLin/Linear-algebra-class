...
class LinearSystem(object):
    ...
    def add_multiple_times_row_to_row(self, coefficient, row_to_add, row_to_be_added_to):
        add_vector= self.planes[row_to_add].normal_vector.times_scalar(coefficient)
        add_term= self.planes[row_to_add].constant_term*coefficient
        new_vector= self.planes[row_to_be_added_to].normal_vector.plus(add_vector)
        new_constant= self.planes[row_to_be_added_to].constant_term + add_term
        self.planes[row_to_be_added_to]= Plane(new_vector, new_constant)
        pass # add your code here
